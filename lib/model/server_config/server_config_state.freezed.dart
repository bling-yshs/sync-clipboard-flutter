...
mixin _$ServerConfigState {
 ...
 ServerConfigList get configList; String? get editingConfigId; String get name; String get url; String get username; String get password; bool get isSaving;
...
@override
int get hashCode => Object.hash(runtimeType,configList,editingConfigId,name,url,username,password,isSaving);

@override
String toString() {
  return 'ServerConfigState(configList: $configList, editingConfigId: $editingConfigId, name: $name, url: $url, username: $username, password: $password, isSaving: $isSaving)';
}
...
@useResult
$Res call({
 ServerConfigList configList, String? editingConfigId, String name, String url, String username, String password, bool isSaving
});
...
/// Create a copy of ServerConfigState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? configList = null,Object? editingConfigId = freezed,Object? name = null,Object? url = null,Object? username = null,Object? password = null,Object? isSaving = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ServerConfigList configList,  String? editingConfigId,  String name,  String url,  String username,  String password,  bool isSaving)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerConfigState() when $default != null:
return $default(_that.configList,_that.editingConfigId,_that.name,_that.url,_that.username,_that.password,_that.isSaving);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ServerConfigList configList,  String? editingConfigId,  String name,  String url,  String username,  String password,  bool isSaving)  $default,) {final _that = this;
switch (_that) {
case _ServerConfigState():
return $default(_that.configList,_that.editingConfigId,_that.name,_that.url,_that.username,_that.password,_that.isSaving);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ServerConfigList configList,  String? editingConfigId,  String name,  String url,  String username,  String password,  bool isSaving)?  $default,) {final _that = this;
switch (_that) {
case _ServerConfigState() when $default != null:
return $default(_that.configList,_that.editingConfigId,_that.name,_that.url,_that.username,_that.password,_that.isSaving);case _:
  return null;
...
class _ServerConfigState implements ServerConfigState {
  const _ServerConfigState({required this.configList, this.editingConfigId, this.name = '', this.url = '', this.username = '', this.password = '', this.isSaving = false});
...
/// Create a copy of ServerConfigState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? configList = null,Object? editingConfigId = freezed,Object? name = null,Object? url = null,Object? username = null,Object? password = null,Object? isSaving = null,}) {
